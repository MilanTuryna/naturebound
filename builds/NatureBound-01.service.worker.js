...
/** @type {string} */
const CACHE_VERSION = '1775484911|11546745687';
/** @type {string} */
const CACHE_PREFIX = 'NatureBound-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'NatureBound-01.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["NatureBound-01.html","NatureBound-01.js","NatureBound-01.offline.html","NatureBound-01.icon.png","NatureBound-01.apple-touch-icon.png","NatureBound-01.audio.worklet.js","NatureBound-01.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["NatureBound-01.wasm","NatureBound-01.pck"];
